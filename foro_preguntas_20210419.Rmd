...
>Nota: la **alternativa 1**, debiera ser la forma más intuitiva de seguir.
...
- Las alternativas 3 a 5, son variantes que podrian ser utiles cuando las exigencias del problema a resolver, requiere de más opciones; y donde quieren más control sobre la tabla generada, y el objeto que con esta se genera. Estas alternativas se incluyen  como ilustraciones. 
