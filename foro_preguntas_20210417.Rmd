...
El problema generado, esta en la forma en que se escribe el codigo de cbind. Este no esta cerrado, y el argumento "na.rm=TRUE" esta generando una distorsión en el calculo de los promedios de items.
