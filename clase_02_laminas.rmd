...
#  background_color = 'white',
  ...
  ".grey"  = list(color = "grey80"),  
  ".bold_white" = list(color = "white", "font-weight" = "bold"),
  ".small" = list("font-size" = "90%"),
  ".pull_center"  = list("float" = "center" , "width" = "50%"),
  ...
  ".pull_r_50"  = list("float" = "right", "width" = "45%"),
...
# preview slides
# xaringan::inf_mr('psi2301_c02_00.rmd')
...
### .text_70[Visualización de datos y estadística descriptiva]

<br>

.text_100[Carrasco, D., PhD]

.text_70[Centro de Medición MIDE UC]

<br>

.text_70[PS2301]

.text_70[Métodos de Investigación en Ciencias Sociales]

.text_70[Santiago, Marzo 15]

<br>

```{r echo=FALSE, out.width = '10%'}
knitr::include_graphics('./img/mide_uc_2019_logo.svg')
```
...
**Cómo importar un archivo excel**
...
### `readxl::read_xlsx` es una manera de llamar la funcion sin abrir la librería                        
data_life_wide <- readxl::read_xlsx(
...
```{r echo=FALSE, out.width = '95%', fig.retina = 3}
knitr::include_graphics('./files/life_expectancy_plot.png')
```

---

**Qué podemos observamos en el gráfico**
...
En cada año, tenemos una alta variablidad respecto a la expectativa de vida al nacer. Los rangos se extienden entre 30 a 75 años aproximadamente.
...
Esto es dificil de ver en la gráfica presente. Pero parecieran haber puntos en la ditribución donde hay más observaciones que en otros lugares. Esto se observa respecto a la **densidad** de las líneas. Aquellos lugares donde hay sectores más oscuros, es porque hay más lineas cruzando este lugar. Esto significa que hay más paises en un punto determinado, que en otro sector de la distribución.
...
Podemos graficar la distribución de variables discretas. Sin embargo a diferencia de las variables continuas, en este caso lo que se grafica son .bold_white[frecuencia] o .bold_white[proporciones] de un valor; y por tanto estamos graficando **puntos estimados.**
