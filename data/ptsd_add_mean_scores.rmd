...
data_ptsd <- psi2301::ptsd_data %>%
              ...
              mutate(anx1_r = r4sda::reverse(anx1)) %>%
              mutate(anx4_r = r4sda::reverse(anx4)) %>%
              ## mean score
              mutate(anxi = r4sda::mean_score(
              anx1_r  ,  # [R] Relaxed
              anx2    ,  # Threatened
              anx3    ,  # Awkward
              anx4_r  ,  # [R] Safe
